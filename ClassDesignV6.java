...
class HockeyPlayer implements FilterData{
	...
	//implementations of non-static FilterData interface methods
...
class Output implements StatsTracking{
	...
	public void mainMenu(){
		...
		case 2: r.playerBios(r.getRoster());
			break;
		case 3: FilterData.printLambdaRoster(r.getRoster());
			break;
		case 4: FilterData.printLambdaShoots(r.getRoster());
			break;
		case 5: FilterData.printLambdaBirthplaces(r.getRoster());
			break;
		...
		case 15: FilterData.printGoalieStat(StatsTracking.goalieStats, 3, r.getRoster());
			break;
		case 16: selectYearMenu();
			break;
		case 17: System.out.print("  You selected: EXIT");
			System.exit(0);
			break;
		default: mainMenu();
			break;
